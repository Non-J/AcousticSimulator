    ...
    if (config["transducers"]) {
      ...
      config["transducers"].forEach(transducer => {
        let geometry = new THREE.ConeGeometry(
          transducer["radius"] * global_linear_distance_scale,
          transducer["radius"] * global_linear_distance_scale,
          20,
          20
        );
        ...
        cone.position.set(
          transducer["position"][0] * global_linear_distance_scale,
          transducer["position"][1] * global_linear_distance_scale,
          transducer["position"][2] * global_linear_distance_scale
        );
        cone.lookAt(
          transducer["target"][0] * global_linear_distance_scale,
          transducer["target"][1] * global_linear_distance_scale,
          transducer["target"][2] * global_linear_distance_scale
        );
